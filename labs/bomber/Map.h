...
private:
    ...
    vector<Region::Connection*> regionPathFinding(Point& src, Point& dst, int bomb_count, unordered_set<Region*> visited_regions, unordered_set<Region::Connection*> visited_connections, unordered_map<Region::Connection*, int> best_Bomb_count, bool backTracking, unordered_set<Region*> unlocked_locked_regions);
